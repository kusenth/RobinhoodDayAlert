...
public class PriceHistoryModel implements Serializable {
    ...
    @Column(name = "NEARING_PERCENT_FLAG")
    private String nearingpercentday;
    
    @Column(name = "STOCK_BUY_DATE")
    private Timestamp stockbuydate;
    
    public String getNearingpercentday() {
 		return nearingpercentday;
 	}
	...
	public void setNearingpercentday(String nearingpercentday) {
		this.nearingpercentday = nearingpercentday;
	}    
    ...
    public PriceHistoryModel(String symbol, Float lastprice ,Float currentprice,Timestamp  time,Float profit,Float lowpercentday,Float highpercentday ) {
        this.symbol = symbol;
        this.lastprice = lastprice;
        this.currentprice = currentprice;
        this.timestamp = time;
    ...
    public String toString() {
        return String.format("PRICE_HISTORY[id=%d,symbol='%s', lastprice='%f',currentprice='%f',timestamp='%d',profit='%f']", symbol, lastprice, currentprice,timestamp,profit);
    }
}